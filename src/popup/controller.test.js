...
describe('createPopupController', () => {
  ...
  it('binds and handles settings/version/copy events', async () => {
    ...
    expect(ipTracker.init).toHaveBeenLastCalledWith(6, true, onCopyNotification)

    elements.copyToClipboardButton.dispatchEvent(new Event('click'))
    expect(ipTracker.copyToClipboard).toHaveBeenCalledWith('1.1.1.1', onCopyNotification)
  })
