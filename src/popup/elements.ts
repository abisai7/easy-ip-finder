...
export const getPopupElements = (): PopupElements => ({
	clipboardConfigCheck: document.querySelector(
		"#clipboard-config-check",
	) as HTMLInputElement,
	changeVersionButton: document.querySelector(
		".change-version-btn",
	) as HTMLButtonElement,
	changeVersionButtonText: document.querySelector(
		".change-version-btn-text",
	) as HTMLSpanElement,
	copyToClipboardButton: document.querySelector(
	...
	privacyInfoButton: document.querySelector(
		".privacy-info-btn",
	) as HTMLButtonElement,
	privacyInfoPanel: document.querySelector(
		".privacy-info-panel",
	) as HTMLDivElement,
});
